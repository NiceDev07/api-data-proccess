...
from modules.data_processing.domain.interfaces.tariff_repository import ITariffRepository
from modules.data_processing.domain.interfaces.cache_interface import ICache
from modules.data_processing.domain.entities.tariff import Tariff
